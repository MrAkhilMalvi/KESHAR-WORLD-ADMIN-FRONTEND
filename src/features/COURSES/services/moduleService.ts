...
export const addModule = async (courseId: string, title: string, position: number) => {
  try {
...
export const getModules = async (courseId: string) => {
  try {
    const response = await axios.post(AUTH_ENDPOINTS.modules.getModules, { couses_id: courseId });
    return response?.data;
  } catch (error: any) {
    throw error.response?.data || error.message;
  }
...
export const updateModule = async (moduleId: string, title: string, position: number) => {
  try {
...
export const deleteModule = async (id: string) => {
  try {
    const response = await axios.delete(AUTH_ENDPOINTS.modules.deleteModules);
    return response?.data;
  } catch (error: any) {
    throw error.response?.data || error.message;
  }
